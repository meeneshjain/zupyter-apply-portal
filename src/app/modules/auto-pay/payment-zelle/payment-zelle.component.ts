...
@Component({
  selector: 'app-payment-zelle',
  templateUrl: './payment-zelle.component.html',
  styleUrls: ['./payment-zelle.component.scss']
})
export class PaymentZelleComponent implements OnInit {
